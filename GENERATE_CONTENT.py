                ...
                const DemonAI = {
                    ...
                    startListening: function() {
                        ...
                        try {
                            ...
                            this.recognition.interimResults = true; // CHANGED TO TRUE FOR FASTER FEEDBACK
                            ...
                            this.recognition.onresult = (event) => {
                                ...
                                if (finalTranscript) {
                                    ...
                                    // STOP RECOGNITION BEFORE PROCESSING TO PREVENT ECHO
                            ...
                            this.recognition.onerror = (event) => {
                                ...
                                // IGNORE TRIVIAL ERRORS TO KEEP LISTENING
                                if (event.error === 'no-speech') {
                                    // Do nothing, just let it loop or restart
                                    return;
                                }
                            ...
                            this.recognition.onend = () => {
                                ...
                                if (this.isListening) {
                                    console.log("Restarting listener (Continuous Loop)...");
                                    try {
                                        this.recognition.start();
                                    } catch(e) {
                                        console.log("Restart error:", e);
                                        // If start fails immediately, wait a bit
                                        setTimeout(() => {
