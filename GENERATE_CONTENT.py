    ...
    },
    {
        ...
        "content": """
            ...
            <div style="text-align: center; margin: 2rem 0;">
                <img src="assets/cyber_eye.svg" alt="Cybernetic Sci-Fi Computer Eyeball" style="max-width: 100%; border: 2px solid #ff0000; box-shadow: 0 0 15px #ff0000; background: #000;">
            </div>
