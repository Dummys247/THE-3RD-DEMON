    ...
    },
    {
        ...
        "content": """
            ...
            <div style="text-align: center; margin: 2rem 0;">
                <img src="assets/omni_vision_final.jpg?v=3" alt="Cybernetic Sci-Fi Computer Eyeball" style="max-width: 100%; border: 2px solid #00ffff; box-shadow: 0 0 20px #00ffff;">
            </div>
